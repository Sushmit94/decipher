...
<div className="flex items-center mb-8">
  ...
  <div className="absolute top-3 right-3 inline-flex items-center gap-2 bg-green-900/70 border border-green-500 px-4 py-1 rounded-full text-green-200 font-semibold shadow-sm">
    ...
    <span>COMPLETED</span>
          ...
          <h2 className="text-3xl font-bold mb-6 font-poppins text-white">{QUESTION_5.title}</h2>
          <p className="mb-8 text-lg text-gray-200 font-poppins">{QUESTION_5.description}</p>
          ...
          <div className="bg-black/60 border-2 border-blue-400/50 rounded-lg p-6 mb-6">
            ...
            <div 
              className="font-poppins text-green-400 text-2xl break-all cursor-pointer select-all bg-black/60 p-6 rounded border-2 border-green-400/30 hover:border-green-300/60 transition-all text-center"
              onClick={() => {
            ...
            <p className="text-gray-400 text-sm mt-3 font-poppins text-center">💡 Click the code above to copy it to your clipboard</p>
          </div>
