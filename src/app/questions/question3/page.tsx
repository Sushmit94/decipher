        ...
        <div className="relative z-10 text-white p-8">
          <div className="max-w-4xl mx-auto flex items-center justify-center min-h-screen">
            <div className="bg-black/50 backdrop-blur-sm border-2 border-white/20 rounded-lg p-8 text-center">
              ...
              <p className="text-xl poppinsfont- text-green-200">Loading question status...</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 text-white p-8">
        ...
        <div className="bg-black/50 backdrop-blur-sm border-2 border-white/20 rounded-lg p-8 mb-8">
          <h2 className="text-3xl font-bold mb-6 font-poppins text-white">{QUESTION_3.title}</h2>
          <p className="mb-8 text-lg text-gray-200 font-poppins">{QUESTION_3.description}</p>
          ...
          <div className="bg-black/60 border-2 border-cyan-400/50 rounded-lg p-6 mb-6">
            ...
            <div className="bg-black/60 p-6 rounded border-2 border-cyan-400/30 text-center">
              ...
              />
              <p className="text-sm text-gray-300 font-poppins mt-4">Right-click and save the image, then analyze it for hidden data!</p>
            </div>
          </div>
