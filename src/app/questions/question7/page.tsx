...
export default function Question7Page() {
  ...
  const checkQuestionCompletion = async () => {
    ...
    try {
      ...
      // Question 7 requires 100 + 150 + 150 + 200 + 300 + 400 + 500 = 1800 total points
      // If points >= 1800, then question 7 is already solved
      if (points >= 7) {
        setCompleted(true);
        setIsSuccess(true);
      }
    ...
    if (flagInput.trim() === QUESTION_7.flag) {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          setTimeout(() => {
            router.push('/questions/question8');
          }, 3000);
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                <span className="group-hover:animate-pulse">
                  {isSubmitting ? 'SUBMITTING...' : completed ? 'COMPLETED' : 'CASE CLOSED'}
                </span>
              </button>
            </div>
          </form>
